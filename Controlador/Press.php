...
class ControladorPress extends ControladorBase
{
    ...
    protected function Inicio()//La accion por defecto para inicio (si no se envian parametros)
    {
        //$this->ComprobarLogin();

        $this->Header = file_get_contents("Vista/Secciones/Header.html");
        $this->Contenido = file_get_contents("Vista/Contenido/Press/Inicio.html"); 
